        ...
        child: BlocListener<WallpaperCubit, WallpaperState>(
          listener: (context, state) {
            if (state is WallpaperAppliedSuccess) {
              Snackbar.show(context, 'Wallpaper applied successfully',
                  ContentType.success);
            } else if (state is WallpaperAppliedFailed) {
              Snackbar.show(
                  context, 'Failed to apply wallpaper', ContentType.failure);
            }
          },
          child: Stack(
            fit: StackFit.expand,
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () async {
                            await context.read<WallpaperCubit>().setWallpaper(
